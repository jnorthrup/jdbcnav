...
/**
 * jdbcnav.app.usecase.UseCase import scanner
 * <p/>
 ...
 * the Jdbcnav IT GUI with incorporated laszlo generators and some possible future birdcage mods.
 */
...
//        frame.setVisible(true);
        try {
            ...
            Object[] arr;
            //cheap hack -- load a bogus xml jdbcnav.app.dws.doc and parse no relevant tags.
...
//        usecaseTree.setRootVisible(false);
    ...
    static void updateView(String content, String fname) {
        ...
        try {
            JdbcNav.prepIFrame(new JInternalFrame(), fname, jTextPane, new Rectangle(300, 300, 300, 300));
