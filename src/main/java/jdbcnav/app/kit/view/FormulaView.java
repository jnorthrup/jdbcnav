...
import jdbcnav.app.kit.FileFilter.KitFileFilter;
import jdbcnav.app.kit.FileFilter.SqlFileFilter;
...
*/
    ...
    static String getSqlRecordCount(Collection<String> from, Collection<String> wher) {
        ...
        JdbcNav.getLogger().info("SqlCount: " + x);
        return x;
    }
    ...
    String getOidRecord(Collection<String> from, Collection<String> wher) {
        ...
        JdbcNav.getLogger().info("OIDRecrd: " + x);
        return x;
    }
