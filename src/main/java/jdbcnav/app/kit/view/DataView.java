...
//        tableSorter.setTableHeader(table.getTableHeader());
        ...
        JdbcNav.prepIFrame(dataView, "[live] " + title, jPanel, new Rectangle(210, 0, 700, (int) desktop.getBounds().getHeight()));
    }
    ...
    private static void openBrowser(StringBuilder tbod) {
        ...
        try {
            ...
            JOptionPane.showInternalConfirmDialog(JdbcNav.getFrame().getContentPane(), field);
        }
    }
